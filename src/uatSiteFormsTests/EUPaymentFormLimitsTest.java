...
public class EUPaymentFormLimitsTest {
	...
	@Test (enabled = true , retryAnalyzer = RetryAnalyzer.class)
	  public void test1() throws InterruptedException {
		...
		driver.findElement(By.id("TCs")).click();
		  ...
		  try {
			  assertEquals(driver.findElement(By.xpath("//*[@id=\"europe-form\"]/div[4]/div[2]/label")).getText(), "Please enter Payment Amount.");
			  Reporter.getCurrentTestResult().setStatus(ITestResult.SUCCESS);
		  }catch(Exception e) {
			  Reporter.getCurrentTestResult().setStatus(ITestResult.FAILURE);
			  System.out.println("EU payment form - Negative payment can pass as valid");
			  Reporter.log("EU payment form - Negative payment can pass as valid");
		  }
	...
	@Test (enabled = true , retryAnalyzer = RetryAnalyzer.class)
	  public void test2() throws InterruptedException {
		  ...
		  try {
			  driver.findElement(By.xpath("//*[@id=\"europe-form\"]/div[4]/div[2]/label"));
			  driver.findElement(By.id("next"));
			  Reporter.getCurrentTestResult().setStatus(ITestResult.SUCCESS);
		  }catch(Exception e) {
			  Reporter.getCurrentTestResult().setStatus(ITestResult.FAILURE);
			  System.out.println("EU payment form - Payment is not limited! More than $99999.99 still can be paid.");
			  Reporter.log("EU payment form - Payment is not limited! More than $99999.99 still can be paid.");
		  }
